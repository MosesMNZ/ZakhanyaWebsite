...
?>
    ...
    <section class="about" id="about">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="sub-txt titles2" style="text-align: center; color: #4c4c4c;">
                        <h3>Welcome to Zakhanya Systems</h3>
                        <p>Your software development experts</p>
                    </div>
                    <div class="row">
                        <div class="col-md-6" style="color: #4c4c4c;">
                            <p class="sub-text" style="font-size: 16.9px; margin-top:0; color: #4c4c4c;">
                            <?php
                                $myfile = fopen("aboutusP1.txt", "r") or die("Unable to open file!");
                                echo fread($myfile,filesize("aboutusP1.txt"));
                                fclose($myfile);
                            ?>
                            <br><br>
                            <?php
                                $myfile = fopen("aboutusP2.txt", "r") or die("Unable to open file!");
                                echo fread($myfile,filesize("aboutusP2.txt"));
                                fclose($myfile);
                            ?>
                            </p>
                        </div>
                        <div class="col-md-6">
                            <img src="../ressources/mac1.jpg" alt="" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
